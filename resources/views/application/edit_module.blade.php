...
<div class="container col-sm-10">
  <form class="well form-horizontal" action="{{asset('/application/edit_module')}}" method="post"  id="contact_form">
    <fieldset>
      <!-- Form Name -->
      ...
      <div class="form-group">
        ...
        <input name="time" placeholder="ex. 星期二 9:00-12:00" class="form-control"  type="text">
          </div>
        </div>
      </div>
            ...
            <fieldset>
              ...
              <div class="form-group">
                ...
                <div class="col-md-4 inputGroupContainer">
                  <div class="input-group">
                    ...
                    <input  name="date" placeholder="課程日期 ex.9/18" class="form-control"  type="text">
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                <label class="col-md-4 control-label">上課時間</label>
                  ...
                  <div class="input-group">
                      <span class="input-group-addon"><i class="glyphicon glyphicon-time"></i></span>
                <input name="time" placeholder="ex. 9:00-12:00" class="form-control"  type="text">
                  </div>
                </div>
              </div>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form class=" form-horizontal" action="{{asset('/application/edit_module')}}" method="post"  id="edit_form">
            <fieldset>
              <!-- 此處input name尚未更改 -->
              <!-- Text input-->
