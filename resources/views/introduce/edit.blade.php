...
<div class="panel-group">
      ...
      @foreach($introduce_questions as $introduce_question)
        <ul>
          ...
          <div class="row">
                ...
                <div class="modal-dialog">
                  <!-- Modal content-->
                    <div class="modal-content">
                      <form action="{{ asset('/introduce/edit/'.$introduce_question->id) }}" method="post">
                      {{ csrf_field() }}
            ...
            <div class="col-sm-1">
              <form action="{{ url('introduce/edit/'.$introduce_question->id) }}" method="POST">
                {!! csrf_field() !!}
                {!! method_field('DELETE') !!}
  ...
  <div class="panel panel-info" style="margin-bottom:  15%;">
    ...
    <div class="panel-body">
      <form action="{{ asset('/introduce/edit') }}" method="POST" name="add">
        {{ csrf_field() }}
        <h4>問題</h4>
        <div class="input-group">                  
          <span class="input-group-addon"><i class="glyphicon glyphicon-education"></i></span>
