  ...
  <div class="tab-content">
    <div id="all" class="tab-pane fade in active">
      ...
      <div class="list-group">
        ...
        <a href="{{$single_class->video}}" class="list-group-item list-group-item-success" target="_blank">{{$single_class->name}}</a>
        @endif
        @endforeach

        @foreach ($module_classes as $module_class)
        @if( $module_class->video!=NULL )
        <a href="{{$module_class->video}}" class="list-group-item list-group-item-info" target="_blank">{{$module_class->name}}</a>
        @endif
        @endforeach
